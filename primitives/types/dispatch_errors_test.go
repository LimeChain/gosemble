...
func Test_EncodeDispatchError(t *testing.T) {
	var testExamples = []struct {
		...
		{label: "Encode(DispatchErrorCustomModule)", input: NewDispatchErrorModule(CustomModuleError{}), expectation: []byte{0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
	}
...
func Test_DecodeDispatchError(t *testing.T) {
	var testExamples = []struct {
		...
		{label: "DecodeDispatchError(0x03, 0x00, 0x00, 0x00)", input: []byte{0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}, expectation: NewDispatchErrorModule(CustomModuleError{})},
	}

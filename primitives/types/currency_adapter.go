...
type CurrencyAdapter interface {
	...
	DepositIntoExisting(who AccountId[SignerAddress], value sc.U128) (Balance, DispatchError)
	...
	Withdraw(who AccountId[SignerAddress], value sc.U128, reasons sc.U8, liveness ExistenceRequirement) (Balance, DispatchError)
}

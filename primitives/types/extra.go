...
type SignedExtra interface {
	...
	PreDispatch(who AccountId[SignerAddress], call Call, info *DispatchInfo, length sc.Compact) (sc.Sequence[Pre], TransactionValidityError)
...
func (e signedExtra) Validate(who AccountId[SignerAddress], call Call, info *DispatchInfo, length sc.Compact) (ValidTransaction, TransactionValidityError) {
...
func (e signedExtra) PreDispatch(who AccountId[SignerAddress], call Call, info *DispatchInfo, length sc.Compact) (sc.Sequence[Pre], TransactionValidityError) {
	pre := sc.Sequence[Pre]{}

...
func (ct *OnChargeTransaction) CorrectAndDepositFee(who primitives.AccountId[types.PublicKey], correctedFee types.Balance, tip types.Balance, alreadyWithdrawn sc.Option[types.Balance]) types.TransactionValidityError {

...
func (ct *OnChargeTransaction) CorrectAndDepositFee(who primitives.AccountId[types.SignerAddress], correctedFee types.Balance, tip types.Balance, alreadyWithdrawn sc.Option[types.Balance]) types.TransactionValidityError {
...
func (ct *OnChargeTransaction) WithdrawFee(who primitives.AccountId[types.SignerAddress], call primitives.Call, info *types.DispatchInfo, fee types.Balance, tip types.Balance) (

...
var (
	...
	callSetBalanceArgsBytes = sc.NewVaryingData(primitives.MultiAddress{}, sc.Compact{}, sc.Compact{}).Bytes()
)
...
func Test_Call_SetBalance_new(t *testing.T) {
	...
	expected := callSetBalance{
		Callable: primitives.Callable{
			...
			Arguments:  sc.NewVaryingData(primitives.MultiAddress{}, sc.Compact{}, sc.Compact{}),
		},

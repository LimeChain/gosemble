...
type storage struct {
	Account            support.StorageMap[types.AccountId[types.PublicKey], types.AccountInfo]
...
func newStorage() *storage {
	...
	return &storage{
		Account:            support.NewHashStorageMap[types.AccountId[types.PublicKey], types.AccountInfo](keySystem, keyAccount, hashing.Blake128, types.DecodeAccountInfo),

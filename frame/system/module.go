...
type Module interface {
	...
	ResetEvents()
	Get(key primitives.AccountId[primitives.SignerAddress]) (primitives.AccountInfo, error)
	CanDecProviders(who primitives.AccountId[primitives.SignerAddress]) (bool, error)
	DepositEvent(event primitives.Event)
	TryMutateExists(who primitives.AccountId[primitives.SignerAddress], f func(who *primitives.AccountData) sc.Result[sc.Encodable]) (sc.Result[sc.Encodable], error)
	...
	StorageAccount(key types.AccountId[types.SignerAddress]) (types.AccountInfo, error)
	StorageAccountSet(key types.AccountId[types.SignerAddress], value types.AccountInfo)
...
func (m module) StorageAccount(key types.AccountId[types.SignerAddress]) (types.AccountInfo, error) {
	return m.storage.Account.Get(key)
}

func (m module) StorageAccountSet(key types.AccountId[types.SignerAddress], value types.AccountInfo) {
...
func (m module) Get(key primitives.AccountId[primitives.SignerAddress]) (primitives.AccountInfo, error) {
	return m.storage.Account.Get(key)
}

func (m module) CanDecProviders(who primitives.AccountId[primitives.SignerAddress]) (bool, error) {
	acc, err := m.Get(who)
	if err != nil {
		return false, err
	}
...
func (m module) TryMutateExists(who primitives.AccountId[primitives.SignerAddress], f func(*primitives.AccountData) sc.Result[sc.Encodable]) (sc.Result[sc.Encodable], error) {
...
func (m module) incProviders(who primitives.AccountId[primitives.SignerAddress]) (primitives.IncRefStatus, error) {
...
func (m module) decrementProviders(who primitives.AccountId[primitives.SignerAddress], maybeAccount *sc.Option[primitives.AccountInfo]) sc.Result[sc.Encodable] {
...
func (m module) incrementProviders(who primitives.AccountId[primitives.SignerAddress], account *primitives.AccountInfo) sc.Result[sc.Encodable] {
...
func (m module) decProviders(who primitives.AccountId[primitives.SignerAddress]) (primitives.DecRefStatus, primitives.DispatchError) {
...
func (m module) onCreatedAccount(who primitives.AccountId[primitives.SignerAddress]) {
	// hook on creating new account, currently not used in Substrate
	//T::OnNewAccount::on_new_account(&who);
	m.DepositEvent(newEventNewAccount(m.Index, who))
}

func (m module) onKilledAccount(who primitives.AccountId[primitives.SignerAddress]) {

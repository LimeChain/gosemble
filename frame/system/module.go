...
func (m module) Metadata() primitives.MetadataModule {
	...
	m.mdGenerator.BuildMetadataTypeRecursively(reflect.ValueOf(primitives.ValidTransaction{}), &sc.Sequence[sc.Str]{"sp_runtime", "transaction_validity", "ValidTransaction"}, nil, nil)
	...
	// type 871
	m.mdGenerator.BuildMetadataTypeRecursively(reflect.ValueOf(primitives.InvalidTransaction{}), &sc.Sequence[sc.Str]{"sp_runtime", "transaction_validity", "InvalidTransaction"}, new(primitives.InvalidTransaction).MetadataDefinition(), nil)

	// type872
	m.mdGenerator.BuildMetadataTypeRecursively(reflect.ValueOf(primitives.UnknownTransaction{}), &sc.Sequence[sc.Str]{"sp_runtime", "transaction_validity", "UnknownTransaction"}, new(primitives.UnknownTransaction).MetadataDefinition(), nil)

	// type 870
	m.mdGenerator.BuildMetadataTypeRecursively(reflect.ValueOf(primitives.TransactionValidityError{}), &sc.Sequence[sc.Str]{"sp_runtime", "transaction_validity", "TransactionValidityError"}, new(primitives.TransactionValidityError).MetadataDefinition(), nil)

	m.mdGenerator.BuildMetadataTypeRecursively(reflect.ValueOf(primitives.TransactionValidityResult{}), &sc.Sequence[sc.Str]{"Result"}, new(primitives.TransactionValidityResult).MetadataDefinition(), nil)

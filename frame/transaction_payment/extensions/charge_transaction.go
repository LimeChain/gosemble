...
func (ct chargeTransaction) WithdrawFee(who primitives.AccountId[primitives.PublicKey], call primitives.Call, info *primitives.DispatchInfo, fee primitives.Balance, tip primitives.Balance) (sc.Option[primitives.Balance], error) {
...
func (ct chargeTransaction) CorrectAndDepositFee(who primitives.AccountId[primitives.PublicKey], correctedFee primitives.Balance, tip primitives.Balance, alreadyWithdrawn sc.Option[primitives.Balance]) error {
